		...
		return (
			<div>
				<ol className="breadcrumb float-xl-right">
					<li className="breadcrumb-item"><Link to="/dashboard/v4">Home</Link></li>
					<li className="breadcrumb-item"><Link to="/dashboard/v4">Dashboard</Link></li>
					<li className="breadcrumb-item active">Dashboard v2</li>
				</ol>
				<h1 className="page-header">Dashboard v4 <small>header small text goes here...</small></h1>
				<div className="row">
					...
					<div className="col-xl-4">
						<Panel>
							...
							<div className="list-group">
								<Link to="/dashboard/v4" className="list-group-item list-group-item-inverse list-group-item-action d-flex justify-content-between align-items-center text-ellipsis">
									1. United State 
				...
				<div className="row">
						...
						<Panel className="bg-light">
							...
							<PerfectScrollbar className="chats" style={{height: '260px'}} options={{suppressScrollX: true}}>
								<div className="left">
									...
									<Link to="/dashboard/v4" className="name">Sowse Bawdy</Link>
									<Link to="/dashboard/v4" className="image"><img alt="" src="/assets/img/user/user-12.jpg" /></Link>
								...
								<div className="right">
									...
									<Link to="/dashboard/v4" className="name"><span className="label label-primary">ADMIN</span> Me</Link>
									<Link to="/dashboard/v4" className="image"><img alt="" src="/assets/img/user/user-13.jpg" /></Link>
									<div className="message">
								...
								<div className="left">
									...
									<Link to="/dashboard/v4" className="name">Neck Jolly</Link>
									<Link to="/dashboard/v4" className="image"><img alt="" src="/assets/img/user/user-10.jpg" /></Link>
									<div className="message">
								...
								<div className="left">
									...
									<Link to="/dashboard/v4" className="name">Shag Strap</Link>
									<Link to="/dashboard/v4" className="image"><img alt="" src="/assets/img/user/user-14.jpg" /></Link>
									<div className="message">
					...
					<div className="col-xl-4 col-lg-6">
						<Panel>
							...
							<div className="list-group">
								<Link to="/dashboard/v4" className="list-group-item list-group-item-action d-flex justify-content-between align-items-center text-ellipsis">
									Sales Reporting
					...
					<div className="col-xl-4 col-lg-6">
						<Panel>
							...
							<ul className="registered-users-list clearfix">
								<li>
									<Link to="/dashboard/v4"><img src="/assets/img/user/user-5.jpg" alt="" /></Link>
								...
								<li>
									<Link to="/dashboard/v4"><img src="/assets/img/user/user-3.jpg" alt="" /></Link>
									<h4 className="username text-ellipsis">
										Ancient Caviar
										<small>Korean</small>
									</h4>
								...
								<li>
									<Link to="/dashboard/v4"><img src="/assets/img/user/user-1.jpg" alt="" /></Link>
									<h4 className="username text-ellipsis">
										Marble Lungs
										<small>Indian</small>
									</h4>
								...
								<li>
									<Link to="/dashboard/v4"><img src="/assets/img/user/user-8.jpg" alt="" /></Link>
									<h4 className="username text-ellipsis">
										Blank Bloke
								...
								<li>
									<Link to="/dashboard/v4"><img src="/assets/img/user/user-2.jpg" alt="" /></Link>
									<h4 className="username text-ellipsis">
										Hip Sculling
										<small>Cuban</small>
									</h4>
								...
								<li>
									<Link to="/dashboard/v4"><img src="/assets/img/user/user-6.jpg" alt="" /></Link>
									<h4 className="username text-ellipsis">
										Flat Moon
								...
								<li>
									<Link to="/dashboard/v4"><img src="/assets/img/user/user-4.jpg" alt="" /></Link>
									<h4 className="username text-ellipsis">
										Packed Puffs
							...
							<PanelFooter className="text-center">
								<Link to="/dashboard/v4" className="text-inverse">View All</Link>
							</PanelFooter>
						</Panel>
					</div>
				</div>
